use crate::api::{
    ClaimMsg, ClaimsParams, ClaimsResponse, NftConfigResponse, NftContract, ReceiveNftMsg,
    StakedNftsParams, StakedNftsResponse, UnstakeMsg, UpdateUnlockingPeriodMsg, UserNftStakeParams,
